...
import { NFLGameSearch } from '@/components/nfl-game-search'
	...
	return (
		<header>
			<nav
				...
				<div className={cn('mx-12 xl:mx-auto max-w-7xl rounded-full px-6 transition-all duration-300 lg:px-12', scrolled && 'bg-background/50 backdrop-blur-2xl')}>
					<motion.div
						key={1}
