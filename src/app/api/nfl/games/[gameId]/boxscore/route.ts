...
import type { GameBoxScore } from '@/types/nfl';
...
export async function GET(
  ...
  try {
    ...
    const cachedData = getCachedData<GameBoxScore>(cacheKey);
    ...
    return NextResponse.json(
      {
        ...
        message: 'An unexpected error occurred while fetching the game boxscore',
        statusCode: 500,
      },
      { status: 500 }
    );
